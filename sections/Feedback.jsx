  ...
  <section className={`${style.paddings} relative z-10`}>
    ...
    >
      <motion.div
        ...
        className="flex-[0.5] lg:max-w-[370px] flex justify-end flex-col gradient-05 sm:p-8 p-4 rounded-[32px] border-[1px] border-[#6a6a6a] relatie "
      >
        ...
        <div>
          ...
          <p className="mt-[8px] font-normal sm:text-[18px] text-[12px] sm:leading[12px] leading-[16px] text-white">Founder | Metaversus</p>
        </div>
